...
class dxSpot {
	...
	public static void main(String[] args)
	{
		...
		menu.getAccessibleContext().setAccessibleDescription("Help & Info about k0emt's dxSpot interface to dxWorld.com");
		mnuBar.add(menu);
		
		//a group of JMenuItems
		JMenuItem menuItem = new JMenuItem("About k0emt's dxSpot Interface", KeyEvent.VK_A);
		menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, ActionEvent.ALT_MASK));
		menuItem.getAccessibleContext().setAccessibleDescription("About k0emt's dxSpot Interface");
		menuItem.addActionListener(new ActionListener()
				{
			public void actionPerformed(ActionEvent e)
			{
				// the displayed dialog box
				final JDialog frmAbout = new JDialog(frmMain, "About k0emt's dxSpot Interface");
				frmAbout.getContentPane().setLayout(new BorderLayout(5, 5));
				
				// info to display in the center
				String[] info = {"dxSpot " + dxVersion + " by k0emt@dbbear.com",
						dxCopyright, 
						" ", 
